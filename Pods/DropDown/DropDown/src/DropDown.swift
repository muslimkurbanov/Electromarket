...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var viewCornerRadius = DPDConstant.UI.CornerRadius {
		willSet {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = viewCornerRadius
...
extension DropDown {
	...
	public override func layoutSubviews() {
		...
		let shadowPath = UIBezierPath(roundedRect: tableViewContainer.bounds, cornerRadius: viewCornerRadius)
